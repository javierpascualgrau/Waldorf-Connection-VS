...
// Mapa interactivo de BuscarRuta.jsx: marcadores de origen/destino + círculo de radio
// ajustable (radiusOrigin en km, actualizado en vivo con el slider). El destino ya no
// tiene radio ajustable — solo se marca el punto, sin círculo.
export default function RouteSearchMap({ origin, destination, radiusOrigin, className = 'h-64 rounded-2xl overflow-hidden' }) {
  ...
  }, [map, origin, destination, radiusOrigin]);
